...
TOPICS = {
    "讲座": ["人工智能前沿技术", "量子计算导论", "大数据分析实战", "Python编程进阶", "科研论文写作", "创新创业论坛"],
    "文艺": ["校园十佳歌手大赛", "话剧展演", "乐器演奏会", "街舞battle", "相声小品专场", "新年音乐会"],
    "体育": ["篮球联赛决赛", "足球友谊赛", "羽毛球锦标赛", "田径运动会", "游泳比赛", "电竞比赛"],
    "科创": ["编程马拉松", "机器人竞赛", "科技创新展", "创业项目路演", "数学建模大赛", "无人机竞速"],
}
